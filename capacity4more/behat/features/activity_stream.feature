Feature: Test activity stream
  ...
  Scenario: Check message is created after Discussion is created in my public group
    ...
    When  a "discussion" is created with title "Discussion added 1" in the group "Discussion Insert 1" with group manager "isaacnewton"
  ...
  Scenario: Check message is created after Event is created in my public group
    ...
    When  a "event" is created with title "Event added" in the group "Discussion Insert 3" with group manager "isaacnewton"
  ...
  Scenario: Message is not changing when the same user updates right after creation earlier than 6 hours ago.
    ...
    And   a "discussion" is created with title "Discussion added 5" in the group "Discussion Insert 5" with group manager "isaacnewton"
  ...
  Scenario: A new message is not created when the same user updates right after he has updated it earlier than 6 hours ago.
    ...
    When  a "discussion" is created with title "Discussion added 6" in the group "Discussion Insert 6" with group manager "isaacnewton"
  ...
  Scenario: New message is created when the other user updates the discussion.
    ...
    When  a "discussion" is created with title "Discussion added 7" in the group "Discussion Insert 7" with group manager "isaacnewton"
    And   I am logged in as user "survivalofthefittest"
  ...
  Scenario: New message is created when updating after 6 hours.
    ...
    When  a "discussion" is created with title "Discussion added 8" in the group "Discussion Insert 8" with group manager "isaacnewton"
