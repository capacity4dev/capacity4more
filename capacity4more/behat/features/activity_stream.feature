Feature: Test activity stream
  ...
  Scenario: Check author is displayed by Firstname + Lastname
    ...
    When  I am logged in as user "isaacnewton"
    And   a "discussion" is created with title "Discussion added 2" in the group "Discussion Insert 2"
    And   I am logged in as user "isaacnewton"
    Then  I should see "Discussion added 2" with author "Isaac Newton" in the activity stream of the group "Discussion Insert 2"
