<section class="group">
  <div class="row">
    <div class="col-md-12">
      <h1 class="main-title">food and nutrition security - rosa</h1>
      <div class="banner">
        <img class="img-responsive" src="images/main/banner.jpg"/>
      </div>
    </div>
  </div>
  <div class="row">
    <div class="col-md-7 col-xs-12">
      ...
      <div class="add-activity">
        <form action="#" class="inline-form">
          <input type="text" placeholder="Add a discussion, ask a question or tell us your idea here..."/>
          <input type="button"/>
        </form>
      </div>
      ...
      <div class="row post discussion-post">
        <div class="col-xs-3 user-info">
          <img src="images/main/profile.jpg" class="img-responsive"/>
        </div>
        <div class="col-xs-9 content-wrapper">
          ...
          <div class="post-content">
            <img src="images/main/post-pic.jpg" class="img-responsive"/>
            <p class="user-text">Farmer-driven research to improve food and nutrition security.</p>
      ...
      <div class="row post discussion-post">
        ...
        <div class="col-xs-9 content-wrapper">
          ...
          <div class="post-content">
            <p class="user-text">Last week capacity4dev launched the updated Food & Nutrition Security – ROSA group. Laura Gualdi, Programme Manager for Food Security</p>
            <p class="comments">2 Comments</p>
            <div class="user-link">
              <div class="row">
                <div class="col-xs-2 link-thumb">
                  <img src="images/main/profile.jpg" class="img-responsive"/>
                </div>
                <div class="col-xs-10 link-content">
                  <div class="post-action">
                    <span class="icon"></span>
      ...
      <!-- End of post -->
      <!-- This is a post -->
      <div class="row post document-post">
        <div class="col-xs-3 user-info">
          <img src="images/main/profile.jpg" class="img-responsive"/>
        </div>
        <div class="col-xs-9 content-wrapper">
      ...
      <div class="row post event-post">
        ...
        <div class="col-xs-9 content-wrapper">
          ...
          <div class="post-content">
            <p class="user-text">10th Forest Governance Forum - Cameroon - 22-24 October 2014</p>
          </div>
        </div>
      </div>
      <!-- End of post -->
      <!-- This is a post -->
      <div class="row post new-member-post">
        <div class="col-xs-3 user-info">
          <img src="images/main/profile.jpg" class="img-responsive"/>
        </div>
        <div class="col-xs-9 content-wrapper">
          <div class="post-action">
            <span class="icon"></span>
            <span class="author sans-font">Sponge Bob</span>
    ...
    <div class="col-md-5 col-xs-12">
      <div class="group-info">
        ...
        <p class="creation">Group created on February 20 2012</p>
        <div class="description">
          The Global Climate Change Alliance (GCCA - www.gcca.eu  (ENGLISH)  www.gcca.eu/fr  (FRENCH)) is an initiative launched by the European Commission (EC) to strengthen dialogue and cooperation on climate change between the EU and devel...
          <a href="#" class="more-link">More Details <span>&#8964;</span></a>
        </div>
