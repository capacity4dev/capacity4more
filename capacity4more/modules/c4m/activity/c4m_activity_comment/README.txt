DESCRIPTION
--------------------------
The c4m_activity_comment module contains the functionality to log activity
...
- c4m_activity_comment_insert : when a comment is created.
- c4m_activity_comment_update : when a comment is updated.
- c4m_activity_comment_delete : when a comment is deleted.
