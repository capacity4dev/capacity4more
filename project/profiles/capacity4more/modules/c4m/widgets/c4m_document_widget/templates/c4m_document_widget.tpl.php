...
<div class="form-group input-wrapper file-wrapper" id="add-document-form">
  ...
  <?php endif; ?>
    <div class="cfm-file-upload-wrapper">
      ...
      <a href="JavaScript://" onclick="Drupal.media.popups.mediaBrowser(function(media){window.location = '#overlay=nobelprize/overlay-file/' + media[0].fid;},{'enabledPlugins[media_default--media_browser_1]': 'media_default--media_browser_1'})"
