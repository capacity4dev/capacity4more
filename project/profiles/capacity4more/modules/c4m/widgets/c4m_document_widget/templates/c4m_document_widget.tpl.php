...
<div class="form-group input-wrapper file-wrapper" id="add-document-form">
  ...
  <?php endif; ?>
    <div class="cfm-file-upload-wrapper">
      ...
      <a href="JavaScript://" onclick="Drupal.media.popups.mediaBrowser(
        function(media){console.log(media);},{'enabledPlugins[media_default--media_browser_1]': 'media_default--media_browser_1'})" ng-click="setFieldName('<?php print $field_name; ?>')" id="link-<?php print $field_name; ?>" ng-class="{'active-library-link':fieldName === '<?php print $field_name; ?>'}">
